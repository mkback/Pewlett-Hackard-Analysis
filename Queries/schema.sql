-- Creating tables for all PH-EmployeeDB files: 
...
-- Pull info for employees retiring 
SELECT first_name, last_name
FROM employees
WHERE birth_date BETWEEN '1952-01-01' AND '1955-12-31';

-- Pull info for empolyees retiring from a given hire date 
SELECT first_name, last_name
FROM employees 
WHERE (birth_date BETWEEN '1952-01-01' AND '1955-12-31')
AND (hire_date BETWEEN '1985-01-01' AND '1988-12-31');

-- Count the difference of the above^^
...
-- Create new table with these employees 
...
-- Join deptartment & dept_manager tables
...
-- Join info of current employees and create a new table 
SELECT ri.emp_no, ri.first_name, ri.last_name, de.to_date
INTO current_emp
FROM retirement_info as ri
LEFT JOIN dept_emp as de
...
-- Use Group by to count employees by deptartment number 
...
-- Pull employee info into new table by Joins
